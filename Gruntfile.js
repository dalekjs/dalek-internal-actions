...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    bump: {
      options: {
        ...
        tagMessage: '%VERSION%',
        push: true,
        pushTo: 'git@github.com:dalekjs/dalek-internal-actions.git'
      }
    },
  ...
  grunt.registerTask('archive', function () {
    ...
    grunt.util.spawn({cmd: 'git', args: ['describe', '--abbrev=0', '--tags']}, function (error, result) {
      ...
      if (grunt.file.isFile('_raw/docs/' + lastTag + '/actions.html')) {
      ...
      grunt.file.copy('report/docs/actions.html', '_raw/docs/' + lastTag + '/actions.html');
